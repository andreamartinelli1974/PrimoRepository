classdef OptModelReg < handle
    ...
    properties
        Fund; % hedge Fund to be replicated
        Regressors; % indexes to be used to replicate the HF
    ...
    methods
        ...
        function obj=OptModelReg(parameters) %Constructor
            obj.Fund=parameters.fund;
            obj.Regressors=parameters.indices;
